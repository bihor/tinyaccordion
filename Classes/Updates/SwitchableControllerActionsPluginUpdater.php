...
namespace Quizpalme\Tinyaccordion\Updates;
...
class SwitchableControllerActionsPluginUpdater implements UpgradeWizardInterface
{
    private const MIGRATION_SETTINGS = [
        [
            'sourceListType' => 'tinyaccordion_pi1',
            'switchableControllerActions' => 'Selection->content',
            'targetListType' => 'tinyaccordion_content',
        ],
        [
            'sourceListType' => 'tinyaccordion_pi1',
            'switchableControllerActions' => 'Selection->content_ui_accordion',
            'targetListType' => 'tinyaccordion_contentui',
        ],
        [
            'sourceListType' => 'tinyaccordion_pi1',
            'switchableControllerActions' => 'Selection->pages',
            'targetListType' => 'tinyaccordion_page',
        ],
        [
            'sourceListType' => 'tinyaccordion_pi1',
            'switchableControllerActions' => 'Selection->pages_ui_accordion',
            'targetListType' => 'tinyaccordion_pageui',
        ],
        [
            'sourceListType' => 'tinyaccordion_pi1',
            'switchableControllerActions' => 'Selection->news',
            'targetListType' => 'tinyaccordion_news',
        ],
        [
            'sourceListType' => 'tinyaccordion_pi1',
            'switchableControllerActions' => 'Selection->news_ui_accordion',
            'targetListType' => 'tinyaccordion_newsui',
        ],
    ];
    ...
    {
        return 'switchableControllerActionsPluginUpdaterTinyaccordion';
    }

    public function getTitle(): string
    {
        return 'Migrates plugin and settings of existing Tinyaccordion plugins using switchableControllerActions';
    }

    public function getDescription(): string
    {
        $description = 'The old Tinyaccordion plugin using switchableControllerActions has been split into separate plugins. ';
